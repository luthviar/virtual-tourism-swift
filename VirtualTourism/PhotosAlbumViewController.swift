...
class PhotosAlbumViewController: UIViewController {
    ...
    private let estimatedItemsPerRow: CGFloat = 3
...
//        let padding = insets.right * (estimatedItemsPerRow + 1)
//        let availableWidth = view.frame.width - padding
//        let widthOfItem = availableWidth / estimatedItemsPerRow
        
   
        let yourWidth = collectionView.bounds.width/estimatedItemsPerRow
